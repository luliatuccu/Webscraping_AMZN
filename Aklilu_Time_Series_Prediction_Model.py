# -*- coding: utf-8 -*-
"""Aklilu_Time_Series_Prediction_Model.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1sec9iHEye-ggIUTRTtGylPJyCIjFzo5b

# 3b-ii-3: Predicted data
#### Develop a Python program to predict the next 10 years from today's date using an LSTM model for future forecasting. (YourLastName_Time_Series_Model.py)
"""
